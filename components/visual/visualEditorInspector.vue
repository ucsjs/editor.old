<template>
    <div class="bg-neutral-800/80 h-full w-full overflow-hidden overflow-y-auto" >
        <div v-if="component">
            <div class="bg-neutral-800 p-2 flex">
                <div class="mr-2">
                    <div class="h-10 w-10 bg-red-700"></div>
                </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-1">
                        ...
                        <div class="mr-2 flex pt-1.5 ml-1">
                            <input 
                                id="static" 
                                type="checkbox" 
                ...
                <div class="bg-neutral-800 w-full border-b border-black text-sm text-neutral-400" v-if="subComponent.open">
                    <div class="py-2">
                        ...
                        >
                            ...
                            <div class="w-4/6 h-7">                                                   
                                <div v-if="subComponent.metadata[property.name]">
                                    <select 
                                ...
                                <input 
                                    ...
                                    @change="changeProperty(component)"
                                />
                                <div v-else-if="property.type == 'boolean' || property.type == 'Boolean' || property.type == 'Bool'" class="text-white px-1">
                                    <label :for="property.name" class="inline-flex relative items-center mb-5 cursor-pointer">
                                        <input 
                                            type="checkbox" 
                                            v-model="subComponent.value[property.name]" 
                                            :id="property.name" 
                                ...
                                <div v-else-if="property.type = 'Ranger'" class="flex">
            ...
            <div class="m-auto mt-2 w-full text-center text-sm text-neutral-400">
                <button
                    class="bg-neutral-800 p-1 px-6 border border-black rounded-sm"
                > 
                    {{ $t("Add Component") }}
                </button>
            </div>
        ...
        refreshToggles(){
            if(this.component){
                for(let key in this.component.components){
                    ...
                    if(this.component.components[key].value){
